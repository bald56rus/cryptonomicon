<template>
  <div class="container mx-auto flex flex-col items-center bg-gray-100 p-4">
    <div class="container">
      ...
      <template v-if="trackedCurrencies.length > 0">
        <hr class="w-full border-t border-gray-600 my-4" />
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
          <div
            @click="selectedCurrency = currency"
            v-for="currency in trackedCurrencies"
            :key="currency.name"
            :class="{
              'border-2': selectedCurrency === currency
            }"
          ...
          >
            ...
            <button
              @click.stop="stopTrackCurrency(currency)"
